    ...
    <div className="bg-card pt-32 pb-16 sm:pt-40 sm:pb-24">
      <div className="container max-w-4xl mx-auto prose prose-slate dark:prose-invert">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-6">
          ...
          {/* Backup of original complaint email link:
          ...
          */}
          <li>To file a complaint, please send a written message to <a href={`mailto:${SITE_EMAIL_SECONDARY}`} className="text-primary hover:underline">{SITE_EMAIL_SECONDARY}</a>.</li>
