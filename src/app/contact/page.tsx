...
export const metadata: Metadata = {
    title: 'Contact Us | James Bond Cleaners Gold Coast',
    description: 'Get a free quote for bond, carpet, or spring cleaning on the Gold Coast. Contact James Bond Cleaners via our form, phone, or email. We\'re ready to help!',
};
