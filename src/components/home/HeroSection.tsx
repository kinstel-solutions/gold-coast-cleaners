        ...
        <div className="container px-4 md:px-6 pt-24 md:pt-0">
          <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <div className="backdrop-blur-sm bg-black/40 border border-white/10 p-6 md:p-10 rounded-3xl shadow-2xl">
              <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white mb-6 drop-shadow-lg leading-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <QuoteDialog
                  trigger={
                    <Button size="lg" className="w-full sm:w-auto rounded-full text-base md:text-lg px-8 py-6 bg-primary hover:bg-primary/90 shadow-[0_0_20px_rgba(var(--primary),0.3)] hover:shadow-[0_0_30px_rgba(var(--primary),0.5)] transition-all transform hover:-translate-y-1">
                      Get a Free Quote
                    </Button>
                  }
                />
