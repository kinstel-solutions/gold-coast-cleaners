          ...
          <div ref={stepsRef} className="space-y-12 md:space-y-24">
            {steps.map((step, index) => (
              ...
              >
                {/* Text Content Side */}
                <div 
                  className={`flex-1 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'} text-center fill-mode-both ${stepsInView ? `animate-in fade-in ${index % 2 === 0 ? 'md:slide-in-from-left-12' : 'md:slide-in-from-right-12'} duration-1000 opacity-100` : 'opacity-0'}`}
                ...
                {/* Center Circle */}
                <div 
                  className={`relative flex items-center justify-center fill-mode-both ${stepsInView ? 'animate-in fade-in zoom-in duration-700 opacity-100' : 'opacity-0'}`}
                ...
                {/* Image Side */}
                <div 
                  className={`flex-1 fill-mode-both ${stepsInView ? `animate-in fade-in ${index % 2 === 0 ? 'md:slide-in-from-right-12' : 'md:slide-in-from-left-12'} duration-1000 opacity-100` : 'opacity-0'}`}
