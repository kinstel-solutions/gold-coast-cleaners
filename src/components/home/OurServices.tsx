    ...
    <section className="py-20 sm:py-32 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div
          ...
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
        ...
        <div className="mt-20 text-center">
          <Button
            asChild
            size="lg"
            className="rounded-full px-10 py-7 text-lg shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1 bg-primary hover:bg-primary/90">
