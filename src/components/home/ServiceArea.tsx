        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {SERVICE_AREA_SUBURBS.map((suburb, index) => (
                <Badge
                  key={suburb}
                  variant="outline"
          ...
          <div 
            ref={imageRef}
            className={`relative fill-mode-both ${imageInView ? 'animate-in fade-in slide-in-from-right-12 duration-1000 delay-200 opacity-100' : 'opacity-0'}`}
          >
